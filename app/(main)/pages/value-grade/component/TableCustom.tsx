...
import { ValueGradeResponse } from '@/app/service/ValueGradeService';
...
interface TableCustomProps {
    dt: React.RefObject<DataTable<ValueGradeResponse[]>>,
    selects: ValueGradeResponse[],
    globalFilter: string,
    editData: (updatedValueGrade: Partial<ValueGradeResponse>) => Promise<void>,
    setSelects: (value: (((prevState: ValueGradeResponse[]) => ValueGradeResponse[]) | ValueGradeResponse[])) => void,
    datum: ValueGradeResponse[],
    ...
    return (
        <>
            ...
            <DataTable
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} grados de valor"
