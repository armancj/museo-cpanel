...
export function TableBodyFunction({
    ...
    const actionBodyTemplate = (rowData: ValueGradeResponse) => {
        return (
            <div>
                <Button
                    icon="pi pi-pencil"
                    className="p-button-rounded p-button-text p-button-warning"
                    tooltip="Editar Grado de Valor"
                ...
                <Button
                    ...
                    tooltip="Eliminar Grado de Valor"
                    tooltipOptions={{ position: 'top' }}
                    onClick={async () => {
    ...
    const dateBodyTemplate = (rowData: ValueGradeResponse, field: keyof ValueGradeResponse) => {
