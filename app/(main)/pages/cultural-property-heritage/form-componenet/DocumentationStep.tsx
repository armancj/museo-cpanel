            ...
            <div className="formgrid grid">
                ...
                <div className="field col-12 md:col-4">
                    ...
                    <InputText
                        ...
                        value={copiesExistenceAndLocation.value}
                ...
                <div className="field col-12 md:col-4">
                    ...
                    <InputText
                        ...
                        value={originalsExistenceAndLocation?.value}
                ...
                <div className="field col-12 md:col-4">
                    ...
                    <InputText
                        ...
                        value={relatedDescriptionUnits?.value}
                ...
                <div className="field col">
                    ...
                    <InputText
                        ...
                        value={relatedPublicationsInformation?.value}
