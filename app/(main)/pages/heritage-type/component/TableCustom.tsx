...
interface TableCustomProps {
    dt: React.RefObject<DataTable<HeritageTypeResponse[]>>,
    selects: HeritageTypeResponse[],
    globalFilter: string,
    editData: (updatedHeritageType: Partial<HeritageTypeResponse>) => Promise<void>,
    setSelects: (value: (((prevState: HeritageTypeResponse[]) => HeritageTypeResponse[]) | HeritageTypeResponse[])) => void,
    datum: HeritageTypeResponse[],
    ...
    return (
        <>
            ...
            <DataTable
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} tipos de patrimonio"
                globalFilter={globalFilter || ''}
                emptyMessage="No hay tipos de patrimonio agregados."
