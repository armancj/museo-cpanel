...
interface TableCustomProps {
    dt: React.RefObject<DataTable<ReproductionConditionsResponse[]>>,
    selects: ReproductionConditionsResponse[],
    globalFilter: string,
    editData: (updatedReproductionConditions: Partial<ReproductionConditionsResponse>) => Promise<void>,
    setSelects: (value: (((prevState: ReproductionConditionsResponse[]) => ReproductionConditionsResponse[]) | ReproductionConditionsResponse[])) => void,
    datum: ReproductionConditionsResponse[],
    ...
    setData: (value: (((prevState: ReproductionConditionsResponse) => ReproductionConditionsResponse) | ReproductionConditionsResponse)) => void
}
    ...
    return (
        <>
            ...
            <DataTable
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} condiciones de reproducción"
                globalFilter={globalFilter || ''}
                emptyMessage="No hay condiciones de reproducción agregadas."
