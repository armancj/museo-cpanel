...
export function TableBodyFunction({
        ...
        return (
            <div>
                <Button
                    ...
                    tooltip="Editar Condición de Reproducción"
                ...
                <Button
                    ...
                    tooltip="Eliminar Condición de Reproducción"
                    tooltipOptions={{ position: 'top' }}
                    onClick={async () => {
    ...
    const dateBodyTemplate = (rowData: ReproductionConditionsResponse, field: keyof ReproductionConditionsResponse) => {
