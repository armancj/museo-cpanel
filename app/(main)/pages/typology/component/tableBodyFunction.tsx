...
export function TableBodyFunction({
    ...
    const nameBodyTemplate = (rowData: TypologyResponse) => {
        return (
            <>
    ...
    const actionBodyTemplate = (rowData: TypologyResponse) => {
        return (
            <div>
                <Button
                    icon="pi pi-pencil"
        className="p-button-rounded p-button-text p-button-warning"
        tooltip="Editar tipología de museo"
        ...
        tooltip="Eliminar tipología de museo"
        tooltipOptions={{ position: 'top' }}
        onClick={async () => {
    ...
    const dateBodyTemplate = (rowData: TypologyResponse, field: keyof TypologyResponse) => {
    ...
    const statusBodyTemplate = (rowData: TypologyResponse) => {
