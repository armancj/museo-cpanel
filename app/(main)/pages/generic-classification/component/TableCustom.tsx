...
interface TableCustomProps {
    dt: React.RefObject<DataTable<GenericClassificationResponse[]>>,
    selects: GenericClassificationResponse[],
    globalFilter: string,
    editData: (updatedGenericClassification: Partial<GenericClassificationResponse>) => Promise<void>,
    setSelects: (value: (((prevState: GenericClassificationResponse[]) => GenericClassificationResponse[]) | GenericClassificationResponse[])) => void,
    datum: GenericClassificationResponse[],
    ...
    return (
        <>
            ...
            <DataTable
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} clasificaciones genéricas"
                globalFilter={globalFilter || ''}
                emptyMessage="No hay clasificaciones genéricas agregadas."
