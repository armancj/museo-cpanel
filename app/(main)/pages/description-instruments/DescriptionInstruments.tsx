...
} from '@/app/(main)/pages/description-instruments/useHookDescriptionInstruments';
import { createdExportExcel } from '@/app/(main)/pages/util/export.functions';
import DescriptionInstrumentsForm
    from '@/app/(main)/pages/description-instruments/component/DescriptionInstrumentsForm';


export default function DescriptionInstruments() {
    const [selects, setSelects] = useState<DescriptionInstrumentsResponse[]>([]);
    const {
        datum,
        dialog,
        setDialog,
    ...
    const dt = useRef<DataTable<DescriptionInstrumentsResponse[]>>(null);

    const openNew = () => {
        setData(emptyDescriptionInstruments);
        setDialog(true);
    };
