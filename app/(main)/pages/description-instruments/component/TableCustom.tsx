...
interface TableCustomProps {
    dt:React.RefObject<DataTable<DescriptionInstrumentsResponse[]>>;
    selects: DescriptionInstrumentsResponse[],
    globalFilter: string,
    editData: (updatedCountry: Partial<DescriptionInstrumentsResponse>) => Promise<void>,
    setSelects: (value: (((prevState: DescriptionInstrumentsResponse[]) => DescriptionInstrumentsResponse[]) | DescriptionInstrumentsResponse[])) => void,
    datum: DescriptionInstrumentsResponse[],
    ...
    return (
        <>
            ...
            <DataTable
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} instrumentos"
                globalFilter={globalFilter || ''}
                emptyMessage="No hay instrumentos agregados."
