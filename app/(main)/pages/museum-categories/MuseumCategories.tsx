...
import { emptyCategoryMuseum, MuseumCategoriesResponse } from '@/app/service/CategoryMuseumService';
import { useHookMuseumCategory } from '@/app/(main)/pages/museum-categories/useHookMuseumCategory';
...
export default function MuseumCategories() {
    ...
    const dt = useRef<DataTable<MuseumCategoriesResponse[]>>(null);

    const openNew = () => {
        setData(emptyCategoryMuseum);
        setDialog(true);
    };
