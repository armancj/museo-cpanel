...
export function TableBodyFunction({
    ...
    const nameBodyTemplate = (rowData: MuseumCategoriesResponse) => {
        return (
            <>
    ...
    const actionBodyTemplate = (rowData: MuseumCategoriesResponse) => {
        return (
            <div>
                <Button
                    icon="pi pi-pencil"
    ...
    const dateBodyTemplate = (rowData: MuseumCategoriesResponse, field: keyof MuseumCategoriesResponse) => {
