...
import { FundTitleResponse, emptyFundTitle } from '@/app/service/FundTitleService';
import { useHookFundTitle } from '@/app/(main)/pages/fund-title/useHookFundTitle';
...
import { TableCustom } from '@/app/(main)/pages/fund-title/component/TableCustom';
import { Dialog } from 'primereact/dialog';
import { DataForm } from '@/app/(main)/pages/fund-title/component/DataForm';
import { FilterMatchMode } from 'primereact/api';


export function FundTitleList() {

    const [selects, setSelects] = useState<FundTitleResponse[]>([]);
    ...
    const dt = useRef<DataTable<FundTitleResponse[]>>(null);

    const openNew = () => {
        setData(emptyFundTitle);
        setDialog(true);
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TableCustom
                        ...
                        setData={setData}
                    />
                    <Dialog visible={dialog} header="Detalles de título de fondo" modal className="p-fluid" footer={dialogFooter}
                            onHide={hideDialog}>
                        <DataForm
                            data={data}
