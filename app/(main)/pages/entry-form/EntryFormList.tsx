...
import { EntryFormResponse, emptyEntryForm } from '@/app/service/EntryFormService';
import { useHookEntryForm } from '@/app/(main)/pages/entry-form/useHookEntryForm';
...
import { TableCustom } from '@/app/(main)/pages/entry-form/component/TableCustom';
import { Dialog } from 'primereact/dialog';
import { DataForm } from '@/app/(main)/pages/entry-form/component/DataForm';
import { FilterMatchMode } from 'primereact/api';


export function EntryFormList() {

    const [selects, setSelects] = useState<EntryFormResponse[]>([]);
    ...
    const dt = useRef<DataTable<EntryFormResponse[]>>(null);

    const openNew = () => {
        setData(emptyEntryForm);
        setDialog(true);
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TableCustom
                        ...
                        setData={setData}
                    />
                    <Dialog visible={dialog} header="Detalles de formulario de entrada" modal className="p-fluid" footer={dialogFooter}
                            onHide={hideDialog}>
                        <DataForm
                            data={data}
