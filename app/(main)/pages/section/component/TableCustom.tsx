...
interface TableCustomProps {
    dt: React.RefObject<DataTable<SectionResponse[]>>,
    selects: SectionResponse[],
    globalFilter: string,
    editData: (updatedSection: Partial<SectionResponse>) => Promise<void>,
    setSelects: (value: (((prevState: SectionResponse[]) => SectionResponse[]) | SectionResponse[])) => void,
    datum: SectionResponse[],
    ...
    return (
        <>
            ...
            <DataTable
                ...
                emptyMessage="No hay secciones agregadas."
