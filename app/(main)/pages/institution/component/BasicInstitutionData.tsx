...
export function BasicInstitutionData(data: InstitutionResponse, onInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, field: string) => void, submitted: boolean, validateField: (field: string) => boolean) {
    return <>
