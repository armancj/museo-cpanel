...
interface InstitutionAddressInputFormProps {
    data: InstitutionResponse;
    onInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, field: string) => void;
    submitted: boolean;
    validateField: (field: (string | undefined | null)) => '' | undefined | null | boolean;
    selectedCountry: AddressResponse | null;
    countries: AddressResponse[];
    onCountryChange: (e: DropdownChangeEvent) => void;
    selectedProvince: AddressResponse | null;
    provinces: AddressResponse[];
    onProvincesChange: (e: DropdownChangeEvent) => void;
    isProvinceDisabled: boolean;
    selectedMunicipality: AddressResponse | null;
    municipalities: AddressResponse[];
    onMunicipalitiesChange: (e: DropdownChangeEvent) => void;
    isMunicipalityDisabled: boolean;
}

export const InstitutionAddressInputForm: React.FC<InstitutionAddressInputFormProps> = ({
    data,
    onInputChange,
    submitted,
    validateField,
