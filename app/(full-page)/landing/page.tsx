            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <ul className="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
                            ...
                            <li>
                                <a href="#about" onClick={toggleMenuItemClick}
                                   className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Nosotros</span>
                                    <Ripple />
                                </a>
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        ...
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Sistema de gestión para
                            la catalogación, preservación y difusión del patrimonio cultural y objetos museables de
                            Cuba. Salvaguardando nuestra historia para las futuras generaciones.</p>
                        <Button type="button" label="Explorar Colección" rounded
                                className="text-xl border-none mt-3 font-normal line-height-3 px-3 text-white"
                                style={{ backgroundColor: '#926941' }} onClick={handleCollectionClick}></Button>
                    </div>
                    <div className="flex justify-content-center md:justify-content-end">
                        <img src="/demo/images/landing/screen-1.png" alt="Imagen de Patrimonio"
                ...
                <div id="features" className="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2" style={{ color: '#926941' }}>Características
                                Principales</h2>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span
                                        className="text-600">Registro detallado de objetos museables y patrimoniales.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span
                                        className="text-600">Localización rápida de objetos por múltiples criterios.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span
                                        className="text-600">Análisis y reportes sobre la colección patrimonial.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div
                                ...
                                <h3 className="text-gray-900 mb-2" style={{ color: '#926941' }}>Ministerio de Cultura de
                                    Cuba</h3>
                                ...
                                <p className="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4"
                                   style={{ maxWidth: '800px' }}>
                                    &quot;Nuestro sistema de gestión patrimonial ha revolucionado la forma en que
                                    preservamos y compartimos la rica historia cultural de Cuba. La digitalización y
                                    catalogación sistemática nos permite proteger nuestro legado para las generaciones
                                    futuras.&quot;
                                </p>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2" style={{ color: '#926941' }}>Patrimonio en Todas
                            Partes</h2>
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        <div className="flex justify-content-center col-12 lg:col-6 p-0 flex-order-1 lg:flex-order-0"
                             style={{ borderRadius: '8px', backgroundColor: '#f5e9d9' }}>
                        ...
                        <div
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal"
                                style={{ color: '#926941' }}>Acceso Móvil</h2>
                            <span className="text-700 text-2xl line-height-3 ml-0 md:ml-2"
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        <div
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal"
                                style={{ color: '#926941' }}>Panel Administrativo</h2>
                            <span className="text-700 text-2xl line-height-3 mr-0 md:mr-2"
                                  style={{ maxWidth: '650px' }}>
                        ...
                        <div className="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 p-0"
                             style={{ borderRadius: '8px', backgroundColor: '#f5e9d9' }}>
                            <img src="/demo/images/landing/mockup-desktop.svg" className="w-11"
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left">
                            <p className="text-700 text-xl line-height-3" style={{ maxWidth: '650px' }}>
                                El Sistema de Gestión de Patrimonio Cultural es una iniciativa del Ministerio de Cultura
                                de Cuba, diseñada para preservar, catalogar y difundir el rico patrimonio histórico y
                                cultural de la nación.
                            </p>
                            <p className="text-700 text-xl line-height-3 mt-4" style={{ maxWidth: '650px' }}>
                                Nuestra misión es salvaguardar los objetos museables y bienes patrimoniales, facilitando
                                su documentación, investigación y acceso para las generaciones actuales y futuras.
                            </p>
                            <p className="text-700 text-xl line-height-3 mt-4" style={{ maxWidth: '650px' }}>
                                Trabajamos en colaboración con museos, archivos, bibliotecas y sitios históricos de toda
                                Cuba para crear un registro digital completo de nuestro patrimonio cultural.
                            </p>
                            <Button type="button" label="Iniciar Sesión" rounded
                                    className="text-xl border-none mt-5 font-normal line-height-3 px-3 text-white align-self-start"
                                    style={{ backgroundColor: '#926941' }} onClick={handleLoginClick}></Button>
                        </div>

                        <div className="flex justify-content-center col-12 lg:col-6 p-0"
                             style={{ borderRadius: '8px' }}>
                            <img src="/demo/images/login/museo-left.jpg" className="w-11" alt="Patrimonio cultural"
                            ...
                            <div className="grid text-center md:text-left">
                                <div className="col-12 md:col-3">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900"
                                        style={{ color: '#926941' }}>Institución</h4>
                                    <Link href="/pages/institucion/sobre-nosotros"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Sobre
                                        Nosotros</Link>
                                    <Link href="/pages/institucion/noticias"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Noticias</Link>
                                    <Link href="/pages/institucion/eventos"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Eventos</Link>
                                    <Link href="/pages/institucion/contacto"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Contacto</Link>
                                    <Link href="/pages/institucion/directorio"
                                          className="line-height-3 text-xl block cursor-pointer text-700">Directorio</Link>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900"
                                        style={{ color: '#926941' }}>Recursos</h4>
                                    <Link href="/pages/recursos/guias-de-uso"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Guías de
                                        Uso</Link>
                                    <Link href="/pages/recursos/documentacion"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Documentación</Link>
                                    <Link href="/pages/recursos/publicaciones"
                                          className="line-height-3 text-xl block cursor-pointer text-700">Publicaciones</Link>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900"
                                        style={{ color: '#926941' }}>Comunidad</h4>
                                    <Link href="/pages/comunidad/foros"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Foros</Link>
                                    <Link href="/pages/comunidad/conferencias"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Conferencias
                                    </Link>
                                    <Link href="/pages/comunidad/preguntas-frecuentes"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Preguntas
                                        Frecuentes</Link>
                                    <Link href="/pages/comunidad/blog"
                                          className="line-height-3 text-xl block cursor-pointer text-700">Blog</Link>
                                </div>

                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    <h4 className="font-medium text-2xl line-height-3 mb-3 text-900"
                                        style={{ color: '#926941' }}>Legal</h4>
                                    <Link href="/pages/legal/terminos-de-uso"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Términos
                                        de Uso</Link>
                                    <Link href="/pages/legal/politica-de-privacidad"
                                          className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Política
                                        de Privacidad</Link>
                                    <Link href="/pages/legal/derechos-de-autor"
                                          className="line-height-3 text-xl block cursor-pointer text-700">Derechos de
                                        Autor</Link>
                                </div>
                            </div>
                        </div>
